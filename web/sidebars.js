...
const sidebars = {
  docs: [
    ...
    {
      type: "doc",
      label: "7.2 - Débogage et trace d'exécution",
      id: "cours/debogage-trace",
      customProps: {
        avancementLabel: "TP2",
        avancement: 0.2,
    ...
    {
      type: "doc",
      label: "8.1 - Intégration des tableaux 2D",
    ...
    {
      type: "doc",
      label: "8.2 - Switch, while, do while",
    ...
    {
      type: "doc",
      label: "10.1 - Écriture dans un fichier",
    ...
    },
    {
      ...
      label: "10.2 - Lecture de fichiers texte",
    ...
    {
      type: "doc",
      label: "11.1 - Fichiers CSV et séparateurs",
      id: "cours/csv",
      customProps: {
        avancementLabel: "TP3",
        avancement: 0.3,
    ...
    {
      type: "doc",
      label: "13.2 - Introduction à la POO",
      id: "cours/poo",
      customProps: {
        avancementLabel: "TP4",
        avancement: 0.3,
  ...
  laboratoire: [
    ...
    },
    {
      ...
      collapsible: true,
      collapsed: collapseBloc1,
      items: ['laboratoire/laboratoire3.1A', 'laboratoire/laboratoire3.1B', 'laboratoire/laboratoire3.1C']
    },
     {
      type: 'category',
      label: 'Laboratoire 3.2',
      collapsible: true,
      collapsed: collapseBloc1,
      items: ['laboratoire/laboratoire3.2A', 'laboratoire/laboratoire3.2B']
    },
   ...
   /* {
    ...
    
    {
      ...
      collapsible: true,
      collapsed: collapseBloc2,
      items: ['laboratoire/laboratoire7.2']
    },
     
    {
    ...
    },
     {
      ...
      collapsible: true,
      collapsed: collapseBloc2,
      items: ['laboratoire/laboratoire8.2A', 'laboratoire/laboratoire8.2B']
    },
    ...
    },
    {
      ...
      collapsible: true,
      collapsed: collapseBloc3,
      items: ['laboratoire/laboratoire11.1']
    },
    
    {
      ...
      collapsible: true,
      collapsed: collapseBloc3,
      items: ['laboratoire/laboratoire11.2']
    },
     {
      type: 'category',
     ...
     {
      type: 'category',
      label: 'Laboratoire 14.1',
      collapsible: true,
      collapsed: collapseBloc3,
      items: ['laboratoire/laboratoire14.1']
    },
     {
      type: 'category',
      label: 'Laboratoire 14.2',
      collapsible: true,
      collapsed: collapseBloc3,
      items: ['laboratoire/laboratoire14.2']
    },
     {
      type: 'category',
      label: 'Laboratoire 15.1',
      collapsible: true,
      collapsed: collapseBloc3,
      items: ['laboratoire/laboratoire15.1']
    },
     {
      type: 'category',
      label: 'Laboratoire 15.2',
      collapsible: true,
      collapsed: collapseBloc1,
      items: ['laboratoire/laboratoire15.2']
    },
  ],
  defis: [{ type: "autogenerated", dirName: "06-defis" }],
  solution: [
    'solution/solution-comprendre-consigne',
    'solution/solution-analyser-probleme',
    'solution/Laboratoire-Solution1.1',
    'solution/solution-affichage-chaines',
    'solution/Laboratoire-Solution1.2A',
    'solution/Laboratoire-Solution1.2B',
    'solution/solution-variables-calculs',
    'solution/laboratoire-Solution2.1A',
    'solution/laboratoire-Solution2.1B',
    'solution/solution-conditions',
    'solution/Laboratoire-Solution2.2A',
    'solution/Laboratoire-Solution2.2B',
    'solution/Laboratoire-Solution2.2C',
    'solution/solution-fonctions',
    'solution/Laboratoire-Solution3.1A',
    'solution/Laboratoire-Solution3.1B',
    'solution/solution-integration-conditions-fonctions',
    'solution/Laboratoire-Solution4.1A',
    'solution/Laboratoire-Solution4.1B',
    'solution/solution-boucle-for',
    ...
    'solution/solution-tableaux-2d',
    'solution/Laboratoire-Solution7.2A',
    'solution/Laboratoire-Solution7.2B',
    'solution/solution-switch-boucles-conditionnelles',
    'solution/solution-integration-menus-tableaux-2d',
    'solution/Laboratoire-Solution9.1',
    'solution/solution-ecriture-fichiers-texte',
    'solution/Laboratoire-Solution9.2',
    'solution/solution-lecture-fichiers-texte',
    'solution/Laboratoire-Solution10.1',
    'solution/solution-fichiers-csv',
    'solution/solution-objets-classes'
  ],
  extra: [{ type: "autogenerated", dirName: "05-extra" }],
  aide: [{ type: "autogenerated", dirName: "07-aide" }],
};
