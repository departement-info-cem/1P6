...
const { entreeSidebarSolutionDefi } = require("./solutions-defis");
...
const sidebars = {
  ...
  solution: [
    ...
    ...entreeSidebarSolutionDefi('solution/Defi-Solution1.1'),
    'solution/Laboratoire-Solution1.2A',
    'solution/Laboratoire-Solution1.2B',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution1.2'),
    'solution/laboratoire-Solution2.1A',
    'solution/laboratoire-Solution2.1B',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution2.1'),
    'solution/Laboratoire-Solution2.2A',
    'solution/Laboratoire-Solution2.2B',
    'solution/Laboratoire-Solution2.2C',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution2.2'),
    'solution/Laboratoire-Solution3.1A',
    'solution/Laboratoire-Solution3.1B',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution3.1'),
    'solution/Laboratoire-Solution4.1A',
    'solution/Laboratoire-Solution4.1B',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution4.1'),
    'solution/Laboratoire-Solution4.2A',
    'solution/Laboratoire-Solution4.2B',
    'solution/Laboratoire-Solution4.2C',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution4.2'),
    ...entreeSidebarSolutionDefi('solution/Defi-Solution5.1'),
    'solution/Laboratoire-Solution6.2A',
    'solution/Laboratoire-Solution6.2B',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution6.2'),
    'solution/Laboratoire-Solution7.2A',
    'solution/Laboratoire-Solution7.2B',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution7.2'),
    ...entreeSidebarSolutionDefi('solution/Defi-Solution8.1'),
    'solution/Laboratoire-Solution9.1',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution9.1'),
    'solution/Laboratoire-Solution9.2',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution9.2'),
    'solution/Laboratoire-Solution10.1',
    ...entreeSidebarSolutionDefi('solution/Defi-Solution10.1'),
    ...entreeSidebarSolutionDefi('solution/Defi-Solution12.2'),
    ...entreeSidebarSolutionDefi('solution/Defi-Solution13.1'),
    ...entreeSidebarSolutionDefi('solution/Defi-Solution13.2'),
  ],
