...
Vous devrez faire preuve d'autonomie et de débrouillardise pour implémenter cette fonctionnalité.
Ce que vous devrez faire (Les étapes pourraient changer selon votre implémentation de la solution, il y a plusieurs bonnes réponses!):
- Lire les meilleurs temps.
- Si le temps est inférieur à un des meilleurs temps actuel, demander le nom du joueur.
- Si le nom est vide, utiliser "Anonyme".
- Trier les scores par temps croissant.
- Garder les 5 meilleurs temps.
- Écrire les meilleurs temps dans le fichier.
...
:::note 🎨 Qualité de l’interface graphique (Windows Forms) – /40 points
...
:::note 🧠 Fonctionnement du jeu (logique, tableaux 2D) – /50 points
