...
sidebar_label: switch et boucles conditionnelles
slug: /defis/switch-boucles-conditionnelles
---

# Défi — `switch` et boucles conditionnelles : Borne de conversion

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais créer un menu avec `switch`;
- tu sais répéter un menu avec `while` ou `do while`;
- tu sais valider une saisie avec `TryParse`.

Si une notion te manque, révise le cours [`switch`, `while` et `do while`](../01-cours/14-switch-while.md).
:::
