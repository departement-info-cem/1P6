...
sidebar_label: "Intégration : menus et tableaux 2D"
slug: /defis/integration-menus-tableaux-2d
---

# Défi d'intégration — Menus et tableaux 2D : Prototypes robots

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais parcourir un tableau 2D avec des boucles imbriquées;
- tu sais organiser un programme en fonctions;
- tu sais créer un menu répété avec `switch` et une boucle conditionnelle.

Si une notion te manque, révise les cours [Tableaux 2D](../01-cours/12-tableaux2d.md), [Fonctions](../01-cours/04-fonctions.md) et [`switch`, `while` et `do while`](../01-cours/14-switch-while.md).
:::
