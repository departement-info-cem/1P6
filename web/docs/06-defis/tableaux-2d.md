---
sidebar_position: 90
sidebar_label: Tableaux 2D
slug: /defis/tableaux-2d
---

# Défi — Tableaux 2D : Plan de salle

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais créer un tableau à deux dimensions;
- tu sais parcourir ses rangées et ses colonnes;
- tu sais utiliser des boucles `for` imbriquées.

Si une notion te manque, révise les cours [Tableaux 2D](../01-cours/12-tableaux2d.md) et [Parcours des tableaux 2D](../01-cours/13-parcours2d.md).
:::
