...
slug: /defis/fonctions
---

# Défi — Fonctions : Commande de pizzas

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais déclarer et appeler une fonction;
- tu sais transmettre des valeurs avec des paramètres;
- tu sais créer une fonction qui retourne une valeur.

Si une notion te manque, révise le cours [Fonctions et portée des variables](../01-cours/04-fonctions.md).
:::
