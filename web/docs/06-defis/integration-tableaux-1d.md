---
sidebar_position: 80
sidebar_label: "Intégration : tableaux 1D et fonctions"
slug: /defis/integration-tableaux-1d
---

# Défi d'intégration — Tableaux 1D et fonctions : Pointages de Uno

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais parcourir deux tableaux de même longueur;
- tu sais utiliser le même indice dans plusieurs tableaux;
- tu sais combiner tableaux, fonctions, conditions et accumulations.

Si une notion te manque, révise les cours [Tableaux 1D](../01-cours/07-tableaux1d.md), [Boucles `for`](../01-cours/08-for.md) et [Fonctions](../01-cours/04-fonctions.md).
:::
