...
sidebar_label: Écriture de fichiers texte
slug: /defis/ecriture-fichiers-texte
---

# Défi — Écriture de fichiers texte : Journal d'entraînement

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais lire et valider une saisie;
- tu sais construire une ligne de texte;
- tu sais ajouter du texte dans un fichier.

Si une notion te manque, révise le cours [Écriture dans un fichier texte](../01-cours/18-ecriture-texte.md).
:::
...
- ajout de texte dans un fichier avec les méthodes présentées dans le cours sur l'écriture de fichiers texte.
