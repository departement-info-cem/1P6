---
sidebar_position: 50
sidebar_label: "Intégration : conditions et fonctions"
slug: /defis/integration-conditions-fonctions
---

# Défi d'intégration — Conditions et fonctions : Bilan d'un atelier d'aide

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais écrire une fonction avec des paramètres et une valeur de retour;
- tu sais choisir une action avec `if`, `else if` et `else`;
- tu sais effectuer des calculs avec des nombres décimaux.

Si une notion te manque, révise les cours [Structures conditionnelles](../01-cours/03-ifelse.md) et [Fonctions et portée des variables](../01-cours/04-fonctions.md).
:::
