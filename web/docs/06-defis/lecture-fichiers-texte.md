...
sidebar_label: Lecture de fichiers texte
slug: /defis/lecture-fichiers-texte
---

# Défi — Lecture de fichiers texte : Analyseur de journal

## Avant de commencer

:::tip Tu peux commencer ce défi si…
- tu sais lire un fichier texte ligne par ligne;
- tu sais séparer une ligne avec `Split`;
- tu sais convertir et accumuler les valeurs obtenues.

Si une notion te manque, révise le cours [Lecture de fichiers texte](../01-cours/17-lecture-texte.md).
:::
